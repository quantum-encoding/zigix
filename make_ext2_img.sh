#!/bin/bash
# Create an ext2-formatted test disk image for Zigix.
# Builds userspace programs and all zig_core_utils, bundles them into a 1GB image.
...
MUSL_OPTS="-Dtarget=x86_64-linux-musl -Dcpu=baseline -Doptimize=ReleaseSmall"
built=0
skipped=0
failed=0
