...
const serial = @import("uart.zig"); // ARM64: UART provides same API as serial
const spinlock = @import("spinlock.zig");
const ext3 = @import("ext3");
const ext3_mount = ext3.mount;
const journal_mod = ext3.journal;
const block_io = ext3.block_io;
const ext4 = @import("ext4");
const extents = ext4.extents;
const inode_ext4 = ext4.inode_ext4;
const block_group_64 = ext4.block_group_64;
const htree = ext4.htree;
const mballoc = ext4.mballoc;
const delayed_alloc = ext4.delayed_alloc;
...
fn readBlock(block_num: u64) ?[*]u8 {
    ...
    while (attempts < 3) : (attempts += 1) {
        ...
        for (0..10000) |_| asm volatile ("yield");
    }
    if (attempts >= 3) {
